...
type DialogContentPropsPlus<T extends ValidComponent = 'div'> = ParentProps<
...
export const DialogContent = <T extends ValidComponent = 'div'>(
	props: PolymorphicProps<T, DialogContentPropsPlus<T>>,
) => {
	const [local, rest] = splitProps(props as DialogContentPropsPlus, [
		'class',
		'children',
		'closable',
	])
...
export const DialogTitle = <T extends ValidComponent = 'h2'>(
	...
	const [local, rest] = splitProps(props as DialogTitlePropsPlus, ['class'])
