...
export default function Queues(props: QueuesProps) {
  ...
  const [expandedQueueName, setExpandedQueueName] = createSignal<string | null>(
    null,
  );
  const [queueTasks, setQueueTasks] = createSignal<
              ...
              <Card>
                <CardContent class="pt-6">
                  <p class="rounded-md border border-dashed p-6 text-center text-sm text-muted-foreground">
                    No queues discovered yet. Queues will appear here once tasks
                    are spawned.
                  </p>
                </CardContent>
              </Card>
                                ...
                                <div class="overflow-x-auto">
                                  <table class="min-w-full divide-y divide-border text-sm">
                                    ...
                                    <tbody class="divide-y divide-border">
                                      <Index
                                        each={queueTasks()[queue.queueName]}
                                      >
                                        {(task) => {
                                          const t = task();
                                          return (
